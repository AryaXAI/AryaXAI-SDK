...
GET_SYNTHETICS_DATA_TAGS = f"{API_VERSION}/synthetics/get_synthetic_data_tags"
DOWNLOAD_SYNTHETICS_DATA_BY_TAG = f"{API_VERSION}/synthetics/download_synthetic_data"